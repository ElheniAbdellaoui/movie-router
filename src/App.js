...
import FilmAdd from "./component/FilmAdd";
  ...
  const [film, setFilm] = useState([
    {
      ...
      videoURL: "https://www.youtube.com/embed/UP_FPVRU5PM",
    },
    {
      id: Math.random(),
      title: "Titanic",
      ...
      videoURL: "https://www.youtube.com/embed/aLRl4mnvfWQ",
    },
    {
      id: Math.random(),
      title: "Avatar",
      ...
      videoURL: "https://www.youtube.com/embed/u3wxCNUbaz0 ",
    },
    {
      id: Math.random(),
      title: "Yuri Boyka",
      ...
      videoURL: "https://www.youtube.com/embed/XGmae-CNj5w",
    },
    {
      id: Math.random(),
      title: "Lift",
      ...
      videoURL: "https://www.youtube.com/embed/m2L-Sa_6MU0",
    },
  ]);
            ...
            element={
              <div>
                <FilmList
                  ...
                  starrate={starrate}
                />
                <FilmAdd add={handleAdd} />
              </div>
            }
          />
          <Route path="/film/:id" element={<Detail film={film} />} />
        </Routes>
      </BrowserRouter>
    </div>
  );
